...
We have integrated DiVRGE into a snakemake pipeline. 
...
Split-read aligners differ in their sam formats. If not specified in the aligners user manual, and easy check includes: 
```
